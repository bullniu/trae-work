...
window.KB_BASE_METALS = [
  ...
  { grade:'Q345R', category:'Fe-1', groupNo:'2', standard:'GB/T 713.2', productForm:'板', supplyStatus:'热轧/控轧/正火', heatTreatment:'轧制或正火', buttThicknessRange:'3-25', composition:{C:'≤0.20',Si:'≤0.55',Mn:'1.10-1.70',P:'≤0.025',S:'≤0.015',Al:'≥0.020'}, tensile:{Rm:'500-640',Rel:'325-345'}, remarks:'压力容器用,常用,屈服强度>295MPa归Fe-1-2组' },
